...
<div x-bind:class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
    ...
    <div class="flex-1 px-4 py-6 overflow-y-auto space-y-7">
        ...
        @if(Gate::allows('view-villages') || Gate::allows('manage-farmers') || Gate::allows('manage-collections'))
        ...
        <!-- Operations Group -->
        @if(Gate::allows('manage-receiving') || Gate::allows('manage-stock') || Gate::allows('view-shops') || Gate::allows('view-orders') || Gate::allows('view-financials'))
            <div class="space-y-1.5">
        ...
        <!-- System Group -->
        @if(Gate::allows('manage-users') || Gate::allows('manage-settings'))
            <div class="space-y-1.5">
