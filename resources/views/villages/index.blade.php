<x-app-layout>
    ...
    <div class="py-12" x-data="{ deleteModalOpen: false, deleteActionUrl: '', villageName: '' }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('error'))
                <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 rounded shadow-sm flex items-center justify-between" role="alert">
                    <div class="flex items-center">
                    ...
                    <button class="text-red-500 hover:text-red-700" onclick="this.parentElement.remove();">&times;</button>
                </div>
            @endif
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ms-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    {{ __('Are you sure you want to delete village') }} <strong x-text="villageName"></strong>? {{ __('This action cannot be undone.') }}
                                </p>
                            </div>
                        </div>
                    </div>
