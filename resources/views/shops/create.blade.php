<x-admin-layout>
    ...
    <div class="max-w-4xl mx-auto">
        <x-admin.card title="{{ __('Shop Registration Details') }}">
            <form method="POST" action="{{ route('shops.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="shop_code" name="shop_code" type="text" class="mt-1 block w-full text-xs font-mono" :value="old('shop_code')" placeholder="{{ __('e.g. SHP-001') }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="name" name="name" type="text" class="mt-1 block w-full text-xs" :value="old('name')" placeholder="{{ __('e.g. Royal Dairy Store') }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="owner_name" name="owner_name" type="text" class="mt-1 block w-full text-xs" :value="old('owner_name')" placeholder="{{ __('e.g. Rajesh Kumar') }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="phone" name="phone" type="text" class="mt-1 block w-full text-xs font-mono" :value="old('phone')" placeholder="{{ __('e.g. 9876543210') }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="email" name="email" type="email" class="mt-1 block w-full text-xs" :value="old('email')" placeholder="{{ __('e.g. owner@example.com') }}" />
                    ...
                    <div>
                        ...
                        <x-text-input id="credit_limit" name="credit_limit" type="number" step="0.01" min="0" class="mt-1 block w-full text-xs font-mono" :value="old('credit_limit', '0.00')" placeholder="0.00" />
                    ...
                    <div>
                        ...
                        <x-text-input id="area" name="area" type="text" class="mt-1 block w-full text-xs" :value="old('area')" placeholder="{{ __('e.g. Main Market, Sector 4') }}" />
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="2" class="mt-1 block w-full border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm text-xs" placeholder="{{ __('Street name, landmark, city...') }}">{{ old('address') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="2" class="mt-1 block w-full border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm text-xs" placeholder="{{ __('Additional terms, delivery timing preferences...') }}">{{ old('notes') }}</textarea>
