<x-admin-layout>
    <x-slot name="header">
        <x-admin.page-header title="{{ __('Edit Shop Outlet') }}" description="{{ $shop->name }} • Code: {{ $shop->shop_code }}">
            <x-slot name="actions">
    ...
    <div class="w-full space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs p-6 lg:p-8 space-y-8">
            <form method="POST" action="{{ route('shops.update', $shop) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="shop_code" name="shop_code" type="text" class="w-full py-2.5 px-3.5 text-xs font-mono font-bold uppercase border-slate-200 rounded-xl shadow-xs" :value="old('shop_code', $shop->shop_code)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="w-full py-2.5 px-3.5 text-xs font-medium border-slate-200 rounded-xl shadow-xs" :value="old('name', $shop->name)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="owner_name" name="owner_name" type="text" class="w-full py-2.5 px-3.5 text-xs font-medium border-slate-200 rounded-xl shadow-xs" :value="old('owner_name', $shop->owner_name)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="phone" name="phone" type="text" class="w-full py-2.5 px-3.5 text-xs font-mono border-slate-200 rounded-xl shadow-xs" :value="old('phone', $shop->phone)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="email" name="email" type="email" class="w-full py-2.5 px-3.5 text-xs font-mono border-slate-200 rounded-xl shadow-xs" :value="old('email', $shop->email)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="credit_limit" name="credit_limit" type="number" step="0.01" min="0" class="w-full py-2.5 px-3.5 text-xs font-mono border-slate-200 rounded-xl shadow-xs" :value="old('credit_limit', number_format($shop->credit_limit, 2, '.', ''))" />
                    ...
                    <div x-show="open" x-collapse class="space-y-5 pt-2">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="area" name="area" type="text" class="w-full py-2.5 px-3.5 text-xs font-medium border-slate-200 rounded-xl shadow-xs bg-white" :value="old('area', $shop->area)" />
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="2" class="w-full py-2.5 px-3.5 text-xs font-medium border-slate-200 focus:border-[#005BAC] focus:ring-2 focus:ring-[#005BAC]/20 rounded-xl shadow-xs bg-white">{{ old('address', $shop->address) }}</textarea>
                ...
                <div x-data="{ open: true, isActive: {{ old('status', (string)(int)$shop->status) === '1' ? 'true' : 'false' }} }" class="bg-emerald-50/40 border border-emerald-100/80 rounded-2xl p-5 lg:p-6 space-y-5">
                    <div class="flex items-center justify-between cursor-pointer" @click="open = !open">
                        <div class="flex items-center gap-3">
