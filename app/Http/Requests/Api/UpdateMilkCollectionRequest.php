...
class UpdateMilkCollectionRequest extends FormRequest
{
    /**
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            $milkCollection = $this->route('milkCollection') ?? $this->route('milk_collection');
            $collectionId = is_object($milkCollection) ? $milkCollection->id : $milkCollection;
    ...
    {
        return [
            'farmer_id.required' => 'Please select a valid farmer.',
